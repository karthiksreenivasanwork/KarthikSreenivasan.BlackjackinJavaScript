...
class BJResult {
    ...
    /**
     * Initialize
     * @param {*} dealersTotalScore Total score earned by the dealer
     * @param {*} playersTotalScore Total score earned by the player.
     */
    constructor(dealersTotalScore, playersTotalScore) {
        if (playersTotalScore == BJNumbers.WinningScore) {
            ...
            if (playersTotalScore > BJNumbers.WinningScore)
                ...
                this._playerWin = true;
            else if (dealersTotalScore == playersTotalScore)
                this._isDraw = true;
            else if (dealersTotalScore > playersTotalScore)
                this._dealerWin = true;
            else if (playersTotalScore > dealersTotalScore)
                this._playerWin = true;
        }
